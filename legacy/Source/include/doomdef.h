...
#ifndef SVN_REV
#define SVN_REV TOSTR(SVN_REVISION_ORG)
#endif
...
#define DOOMLEGACY2_VERSION TOSTR(DOOMLEGACY2_MAJOR) "." TOSTR(DOOMLEGACY2_MINOR) "." TOSTR(DOOMLEGACY2_PATCH) "." TOSTR(DOOMLEGACY2_BUILD)
#endif

#define BUILD_DATE __DATE__ 
#define BUILD_TIME __TIME__

#define FILEDESC "Doom Legacy 2.0 Alpha: Reborn " TOSTR(DOOMLEGACY2_PATCH) "." TOSTR(DOOMLEGACY2_BUILD) " (32Bit/SDL1)"
...
// Fork Versioning
		...
		#define VALUE_VERSION_STRING    TOSTR(DOOMLEGACY2_MAJOR) ", " TOSTR(DOOMLEGACY2_MINOR) ", " TOSTR(DOOMLEGACY2_PATCH) ", " TOSTR(DOOMLEGACY2_BUILD)
...
// Latest Original Code Branch Sourceforge    
		...
		#define VALUE_PRODUCTVSTRING   TOSTR(DOOMLEGACY2_MAJOR) ", " TOSTR(DOOMLEGACY2_MINOR) ", " TOSTR(DL_VER_REV)    
#endif
